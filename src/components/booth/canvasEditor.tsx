...
export function CanvasEditor() {
  ...
  const { canvasRef, fabricCanvas, addText, changeBackgroundColor, canvasHeight } = useCanvasEditor(
    capturedPhotos,
    layoutType
  );
  ...
  return (
    <div className="flex flex-col md:flex-row items-start gap-8 w-full justify-center max-w-5xl animate-in fade-in zoom-in-95 duration-500">     
      <div className="flex flex-col gap-4 w-full md:w-auto items-center">
        <div className="w-full max-w-sm md:max-w-md p-4 md:p-6 bg-muted/30 border rounded-2xl shadow-inner flex justify-center">
          <div 
