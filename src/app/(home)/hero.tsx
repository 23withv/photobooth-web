...
export function Hero() {
  ...
  return (
    <section className="flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-7xl mx-auto px-6 pt-32 pb-12 gap-16 lg:gap-8 flex-1">
      <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-6 flex-1">
        ...
        <p className="text-muted-foreground text-lg md:text-xl max-w-lg">
          Platform photobooth modern dengan filter estetik, stiker kustom, dan
          layout frame premium langsung dari browser Anda.
        </p>
        <div className="pt-4">
          <Button
            size="lg"
