...
const LAYOUTS: LayoutOption[] = [
  { id: "1-grid", label: "Single Shot", icon: Square },
  { id: "2-grid", label: "2 Photos (Strip)", icon: Rows2 },
  { id: "2-strip", label: "2 Photos (Horizontal)", icon: Columns2 },
  { id: "3-strip", label: "3 Photos (Strip)", icon: Rows3 },
  { id: "4-grid", label: "4 Photos (Grid)", icon: LayoutGrid },
  { id: "4-strip", label: "4 Photos (Strip)", icon: Rows4 },
  { id: "6-grid", label: "6 Photos (Grid)", icon: Grip },
  { id: "9-grid", label: "9 Photos (Grid)", icon: Grid3X3 },
];
...
export function LayoutSelectorStep() {
  ...
  return (
    <div className="flex flex-col items-center w-full gap-6 py-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
      <div className="text-center space-y-4 mb-6">
        <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-center">
          Choose Your <span className="text-primary italic">Layout.</span>
        </h2>
        <p className="text-muted-foreground text-lg max-w-md mx-auto text-center">
          Select the perfect grid to capture and frame your favorite moments.
        </p>
      </div>
