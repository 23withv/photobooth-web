...
import { Sparkles, Camera, Image as ImageIcon, LucideIcon, Sticker, Share2, Wand2 } from "lucide-react";
import "../globals.css";

const HERO_CARDS: CardItem[] = [
  { id: 1, title: "Premium Filters", icon: Sparkles, bg: "bg-zinc-900/60 dark:bg-zinc-900/40" },
  { id: 2, title: "Aesthetic Frames", icon: ImageIcon, bg: "bg-zinc-800/60 dark:bg-zinc-800/40" },
  { id: 3, title: "High-Res Capture", icon: Camera, bg: "bg-zinc-700/60 dark:bg-zinc-700/40" },
  { id: 4, title: "Custom Stickers", icon: Sticker, bg: "bg-zinc-900/60 dark:bg-zinc-900/40" },
  { id: 5, title: "Instant Sharing", icon: Share2, bg: "bg-zinc-800/60 dark:bg-zinc-800/40" },
  { id: 6, title: "AI Enhancement", icon: Wand2, bg: "bg-zinc-700/60 dark:bg-zinc-700/40" },
];
          ...
          {stack.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <card.icon
                    className="w-16 h-16 md:w-20 md:h-20 mb-6 opacity-90 text-primary-foreground"
                    strokeWidth={1.5}
                  />
